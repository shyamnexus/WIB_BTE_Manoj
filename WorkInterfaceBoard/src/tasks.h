...
void encoder_task(void *arg); // Task that polls encoders and transmits direction/velocity over CAN
void task_encoder1_pin_monitor(void *arg); // Task that monitors encoder 1 pins and sends state over CAN
